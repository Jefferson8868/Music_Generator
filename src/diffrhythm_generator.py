...
根据五行颜色数据生成对应情绪和传统五音结合的音乐
使用DiffRhythm模型 (https://github.com/ASLP-lab/DiffRhythm)
"""
...
# DiffRhythm API配置
DIFFRHYTHM_API_URL = "https://api.example.com/diffrhythm/generate"  # 替换为实际API地址
DIFFRHYTHM_LOCAL_PATH = None  # 本地DiffRhythm路径，如果使用本地部署
